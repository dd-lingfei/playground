...
_Last updated: 2026-03-07 (auto-detect backlog run)_
...
|---|------|-------|----|--------|-----------|-----|---------|
| [#66194](https://github.com/doordash/ios/pull/66194) | ios | Add barcode detection guardrail to Diglett photo review | PENDING (bitrise building) | PENDING | YES | +219/-18 | 2026-03-07 |
...
| # | Repo | Title | CI | Review | Mergeable | +/- | Updated |
|---|------|-------|----|--------|-----------|-----|---------|
| [#105109](https://github.com/doordash/pedregal/pull/105109) | pedregal | Add async job processor for Diglett pipeline | PENDING (buildkite running) | PENDING | YES | +388/-301 | 2026-03-07 |
| [#105075](https://github.com/doordash/pedregal/pull/105075) | pedregal | Scaffold Diglett graph with GenAI, Snowflake, and Taulu | PASSING | REVIEW_REQUIRED | YES | +1389/-0 | 2026-03-07 |
...
_No open PRs. Last activity: [#20](https://github.com/dd-lingfei/playground/pull/20) Add auto-detect backlog items from unlinked open PRs (MERGED 2026-03-07)_
...
- **REQUEST REVIEW:** PR [#105075](https://github.com/doordash/pedregal/pull/105075) CI all green, +1389/-0, 26 files - needs reviewer
...
- **NEW PR:** [#105109](https://github.com/doordash/pedregal/pull/105109) (async job processor) - CI pending (buildkite running)
